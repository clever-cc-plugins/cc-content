...
| `/cc-content:long-tail-copy`             | Drafts a finished text for any format without a dedicated skill (e.g., whitepaper, landing page …), routing you to a dedicated skill (like press release) when one fits better                    |
